...
if __name__ == "__main__":
    ...
    body_action.fast_move_to([0.39, 1.17, 1.52, 1.47, -0.80,  0.00,  0.00, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.17, 1.52, 1.47, -1.57,  0.00,  0.00, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.46, 1.52, 1.47, -1.57,  0.00,  0.00, 0.00], duration = 1.0)
    ...
    body_action.safe_move_to([0.39, 1.55, 0.00, 1.57,  0.00, -1.57, -1.57, 0.00], velocity = 1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57,  0.00,  0.00, -1.57, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57,  0.00,  1.57, -1.57, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57,  0.00,  3.12, -1.57, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57,  0.00, -1.63, -1.57, 0.00], duration = 1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57,  0.00,  1.63, -1.57, 0.00], duration = 2.0)
    rospy.sleep(.1)
    head_action.look_at(1.0,0.0,1.3, duration = .7)
    body_action.fast_move_to([0.39, 0.60, 0.00, 1.57, -2.16,  1.57, -1.57, 0.00], duration =  1.5)
    body_action.fast_move_to([0.39, 0.60, 0.00, 1.57, -2.16,  1.57,  0.00, 0.00], duration =  1.0)
    body_action.fast_move_to([0.39, 1.55, 0.00, 1.57, -1.57,  1.57,  0.00, 0.00], duration =  1.0)
